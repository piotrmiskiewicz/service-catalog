...
import (
	...
	"github.com/kubernetes-incubator/service-catalog/cmd/migration"
)
...
func NewMigration() *hyperkube.Server {
	...
	hks := hyperkube.Server{
		...
		Long:            "The migration tool migrate Service Catalog resources from API Server to CRDs version",
